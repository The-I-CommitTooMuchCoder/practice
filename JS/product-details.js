...
function loadProductDetails() {
    ...
    if (!product) {
        ...
        document.querySelector('.product-detail-container').innerHTML = '<h1>Product Not Found</h1><p>The selected product details could not be loaded. Please return to the <a href="/cataloguePages/real-flower.html">catalogue</a>.</p>';
        return;
    }
